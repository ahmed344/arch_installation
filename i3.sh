...
sudo pacman -S --noconfirm xorg xorg-xrandr arandr xorg-xinit mesa i3 i3status i3blocks i3lock dmenu terminator picom dunst polkit lxsession lxappearance xbindkeys udiskie udisks2 ntfs-3g wget htop pcmanfm gimp vlc firefox thunderbird rofi feh geany materia-gtk-theme papirus-icon-theme ttf-font-awesome ttf-ubuntu-font-family ttf-droid ttf-dejavu 
